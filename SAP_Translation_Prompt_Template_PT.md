# SAP S/4HANA Localização — Template de Prompt para Tradução XLF
...
- Usar abreviações alemãs padrão quando necessário (Bsp., inkl., Nr., Lfg., Ber., usw., z.B., ggf., bzgl.)
...
- NÃO traduzir: nomes de transações (SE91, SLG1, CG02, VF01, CM40, COR1, etc.)
- NÃO traduzir: nomes de tabelas (TVARVC, STVARV, ZMM_GRPKEY_CONF, etc.)
- NÃO traduzir: nomes de programas, classes, campos técnicos
- NÃO traduzir: acrônimos/códigos (RFC, BOM, MRP, EWM, GHS, LSMW, DMS, ATP, FIFO, etc.)
- NÃO traduzir: "SAP", "ABAP", "Fiori", "WERCS", "EXCEL", "PDF", "MES"
...
- **OTR Texts**: podem ter limites maiores, verificar o maxwidth no XLF
